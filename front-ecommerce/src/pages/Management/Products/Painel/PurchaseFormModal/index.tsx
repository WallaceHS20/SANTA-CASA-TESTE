...
export const PurchaseFormModal = ({ visible, onHide, product, form, onChange, onConfirm }: Props) => {
  ...
  return (
    <Dialog 
      header="Registrar Entrada (Compra)" 
      visible={visible} 
      style={{ width: '45vw' }} 
        ...
        <div className="col-12 mt-3">
           <div className="flex justify-content-between p-3 bg-gray-100 border-round-lg border-1 border-300">
              ...
              <span className="font-bold text-2xl text-primary">
                {(Number(form[PurchaseFormKeys.QUANTITY]) * Number(form[PurchaseFormKeys.UNIT_PRICE])).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}
              </span>
           </div>
        </div>
      </div>
